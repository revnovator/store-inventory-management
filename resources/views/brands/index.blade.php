                                    ...
                                    @foreach($brands as $key => $brand)
                                        <tr>
                                            ...
                                            <td> 
                                                ...
                                                <a href="javascript:;" class="btn btn-sm btn-danger sa-delete" data-form-id="category-delete-{{ $brand->id }}">
                                                    <i class="fa fa-trash"> </i> Delete
                                                </a>

                                                <form id="category-delete-{{ $brand->id }}" action="{{ route('brands.destroy', $brand->id) }}" method="post"> 
                                                    @csrf
                                                    @method('DELETE')
